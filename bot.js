		...
		// It will listen for messages that will start with `!`
			...
			switch(cmd) {					
				...
				case '/stress':
					...
					if (args.count > 0 && args[0].substring(0, 1) == '+' || args[0].substring(0, 1) == '-'){
						mod = args[0];
					}
					else if (args.count > 1 && args[1].substring(0, 1) == '+' || args[1].substring(0, 1) == '-'){
						mod = args[0];						
					}
					...
					if (args.count > 0 && args[0].substring(0, 1) == 'b'){
						botch = args[0].substring(1);
					}
					else if (args.count > 1 && args[1].substring(0, 1) == 'b'){
						botch = args[0].substring(1);						
					}
